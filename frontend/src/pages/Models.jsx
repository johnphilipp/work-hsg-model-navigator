  ...
  return (
    <>
      <button
        ...
        type="button"
        class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200"
      >
      ...
      <div class="grid grid-cols-3 gap-4">
        <div>
          <aside
            ...
            aria-label="Sidebar"
          >
            <div className="shadow h-full px-3 py-4 rounded-lg overflow-y-auto bg-slate-200">
